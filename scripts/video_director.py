...
def _cmd_demo(args: Sequence[str]) -> int:
    ...
    print("\nUnix/macOS:")
    print(f"  bash scripts/video-director.sh doctor {config_path}")
    print(f"  bash scripts/video-director.sh run {config_path} --dry-run")
    print(f"  bash scripts/video-director.sh run {config_path}")
    print("\nWindows:")
